...
class DatasetTemplate(dgl.data.DGLDataset):
    ...
    def __init__(
        ...
        **kwargs
        ...
        cache_dir = "{}/{}-{}-{}-{}-{}".format(
            data_dir, input_dim, train_ratio, val_ratio, seed, time_aggregation
        )
        os.makedirs(cache_dir, exist_ok=True)

        super().__init__(
            name=name, url=url, raw_dir=data_dir, save_dir=cache_dir, **kwargs
        )
    ...
    def load_from_path(self, file_path):
        ...
        self.num_nodes = self.graphs[0].num_nodes()
