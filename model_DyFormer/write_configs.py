...
for dataset in datasets:
    ...
    # with open('./model_DyFormer/configs/GAT_%s.yaml'%dataset, 'w') as f:
    #    yaml.dump(config, f)
    # with open('./model_DyFormer/configs/GAT_RNN_%s.yaml'%dataset, 'w') as f:
    #    yaml.dump(config, f)
    ...
    # with open('./model_DyFormer/configs/DySAT_%s.yaml'%dataset, 'w') as f:
    #    yaml.dump(config, f)
    ...
    # with open('./model_DyFormer/configs/EvolveGCN_O_%s.yaml'%dataset, 'w') as f:
    #    yaml.dump(config, f)
    ...
    #   #  with open('./model_DyFormer/configs/DyTransformer_compact_%s.yaml'%dataset, 'w') as f:
    #   #      yaml.dump(config, f)
    ...
    #     with open('./model_DyFormer/configs/DyGraphTransformer_MLR_%s.yaml'%dataset, 'w') as f:
    #         yaml.dump(config, f)
    #     with open('./model_DyFormer/configs/DyGraphTransformer_%s.yaml'%dataset, 'w') as f:
    #         yaml.dump(config, f)
    import os

    os.makedirs("./model_DyFormer/configs/", exist_ok=True)
    with open(
        "./model_DyFormer/configs/DyGraphTransformer_two_stream_%s.yaml" % dataset, "w"
    ) as f:
        yaml.dump(config, f)
    ...
    #    "num_hidden_layers": 2,
    # }
    # with open('./model_DyFormer/configs/GraphBert_%s.yaml'%dataset, 'w') as f:
    #    yaml.dump(config, f)
