...
python main.py --model tokengt_cd --seed 123 --device_id 0 --dataset collab --ex_name "Comparison among tokengt_cd and tokengt_cdrandom" &
python main.py --model tokengt_cd --seed 222 --device_id 1 --dataset collab --ex_name "Comparison among tokengt_cd and tokengt_cdrandom" &
python main.py --model tokengt_cd --seed 321 --device_id 2 --dataset collab --ex_name "Comparison among tokengt_cd and tokengt_cdrandom" &
python main.py --model tokengt_cdrandom --seed 123 --device_id 3 --dataset collab --ex_name "Comparison among tokengt_cd and tokengt_cdrandom" &
python main.py --model tokengt_cdrandom --seed 222 --device_id 4 --dataset collab --ex_name "Comparison among tokengt_cd and tokengt_cdrandom" &
python main.py --model tokengt_cdrandom --seed 321 --device_id 5 --dataset collab --ex_name "Comparison among tokengt_cd and tokengt_cdrandom" &
...
#python main.py --model tokengt_cd --device_id 0 --dataset collab --seed 123 --ex_name "test" &
#python main.py --model tokengt_cd --device_id 1 --dataset collab --seed 222 --ex_name "test" &
#python main.py --model tokengt_cd --device_id 2 --dataset collab --seed 321 --ex_name "test" &